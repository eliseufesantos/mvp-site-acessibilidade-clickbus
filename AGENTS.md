...
- conectividade real do Gemini: **verificada em 19/09/2026** no domínio autorizado, com respostas 200 dentro do contrato. A disponibilidade, porém, é instável: em 10 chamadas houve 2 sucessos, 3 × HTTP 503 e 5 × HTTP 429 do provedor. Avaliação semântica da qualidade das respostas permanece `NOT RUN`;
